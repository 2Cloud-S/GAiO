    ...
    return (
      ...
      >
        <div className="assessment-success-copy">
          ...
          <h2 className="display section-title">We have held your sample slot.</h2>
          <p className="lede">
            {dateLabel} {selectedDate} at {selectedTime}. This is a front-end demonstration; connect your scheduler when the live workflow is ready.
          </p>
          <button className="button button-signal" type="button" onClick={() => setConfirmed(false)}>
            Choose another time
          </button>
        </div>
      </WarpBackground>
